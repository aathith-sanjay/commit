...
import com.snow.commit.service.AuthService;
...
public class AuthController {
    ...
    @GetMapping("/me")
    public UserDto me(@AuthenticationPrincipal UserPrincipal currentUser) {
        return authService.toUserDto(currentUser.getUser());
    }
}
